...
class TestEmailOutreachAppSimple(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_send_data = {
            ...
            "mailjet_api_key": os.environ.get("MAILJET_API_KEY", "test_key"),
            "mailjet_api_secret": os.environ.get("MAILJET_API_SECRET", "test_secret")
        }
    ...
    def test_process_email_result_simple(self):
        ...
        data = {
            "company_rep_email": "test@example.com",
            "company_rep_name": "Sender",
            "prospect_rep_name": "Recipient",
            "prospect_rep_email": "recipient@example.com",
            "prospect_company_name": "Beta Inc"
        }
    ...
    def test_generate_email_success_status(self, mock_setup_crew, mock_create_tasks, mock_create_agents, mock_setup_llm):
        ...
        mock_create_agents.return_value = (MagicMock(),) * 4
        mock_create_tasks.return_value = (MagicMock(),) * 4
    ...
    @unittest.skipIf(
        os.environ.get("MAILJET_API_KEY") is None or os.environ.get("MAILJET_API_SECRET") is None,
        "Skipping Mailjet tests due to missing API keys"
    )
